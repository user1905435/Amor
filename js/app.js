...
function sbakhir() { Bn.style.display = "none"; setTimeout(stakhir, 500); } function stakhir() { tmbl.innerHTML = "💌 Compartir"; Tombol.style = "margin-top:10px;opacity:1;transform: scale(1)"; ftom = 5; fungsi = 0; }
...
function ditolak() {
	if (fungsi == 1) {
		if (flagg == 1) {
			Bn.style = "margin:12px 0 12px 12px;cursor:default;opacity:0;transition:all 0s ease;"; flagg = 2;
